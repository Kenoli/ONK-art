...
<div id="leftcolumn">
<a href="<?=$_SERVER['HTTP_REFERER']; ?>"><img src="<?=$content['image']; ?>" width="600"  class="fade" ></a>
<p class="plain" ><a href="index.php?opt=image&img=<?=$content['image'];?>"  width="200" ><img src="__assets/plus.png" /></a></p>
</div>
